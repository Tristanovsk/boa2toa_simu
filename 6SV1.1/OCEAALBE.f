...
!    !! Change (harmel) 20200901 to set rfoam, xfoam manually
...
C
      real Ref(39)
      real pwl,azw,pcl,wl,wspd,C,pws,rfoam,xfoam,brdfalbe,w,wlp,paw
