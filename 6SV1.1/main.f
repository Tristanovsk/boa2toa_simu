...
c**********************************************************************c
      ...
      !!!! rfoam as input (set externally as xsal*1000)
        ...
        do l=iinf,isup
           ...
           srm(0)=xmus
           wl=.25+(l-1)*step 
           call oceabrdf(pws,paw,xsal,pcl,wl,rfoam,xfoam,rwat,rglit,
     s         1,1,srm,srp,
     s           sbrdftmp)
	   ...
	   sbrdf(l)=sbrdftmp(1,1)
        ...
        rm(mu)=xmuv
        rm(0)=xmus
        call oceabrdf(pws,paw,xsal,pcl,wlmoy,rfoam,xfoam,rwat,rglit,
     s  	mu,np,rm,rp,
     s           brdfints)
        rm(-mu)=2.*pi-phirad
        rm(mu)=xmus
     ...
     s   	mu,np,rm,rp,
     s           brdfintv)
        call oceaalbe(pws,paw,xsal,pcl,wlmoy,rfoam,xfoam,
     s                albbrdf)
        go to 69
      endif
c
